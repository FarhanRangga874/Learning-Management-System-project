    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('admin.chapters.lessons.store', $chapter) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div x-data="{ 
                        ...
                        <div x-show="type === 'video'" x-transition class="mb-6 p-4 bg-indigo-50 border border-indigo-100 rounded-lg">
                            ...
                            <div x-show="videoSource === 'youtube'">
                                ...
                                <x-text-input id="video_url" class="block mt-1 w-full" type="text" name="video_url" :value="old('video_url')" placeholder="Contoh: https://www.youtube.com/watch?v=dQw4w9WgXcQ" />
