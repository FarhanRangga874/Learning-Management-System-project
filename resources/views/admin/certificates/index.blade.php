    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
                <div>
                    <h3 class="font-bold text-slate-800 text-lg">Sertifikat Siswa</h3>
                    <p class="text-xs text-slate-500">Daftar siswa yang telah menyelesaikan kursus.</p>
                </div>
                
                {{-- TOMBOL SETTINGS BARU --}}
                <a href="{{ route('admin.certificates.settings') }}" class="inline-flex items-center gap-2 bg-slate-900 text-white px-4 py-2 rounded-xl font-bold text-sm hover:bg-slate-800 transition shadow-md">
