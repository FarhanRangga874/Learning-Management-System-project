<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            <a href="{{ route('admin.categories.index') }}" class="p-2 rounded-full bg-white border border-gray-200 text-gray-500 hover:bg-gray-50 transition">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Tambahkan kategori untuk mengelompokkan kursus.</p>
            </div>
        </div>
    </x-slot>
