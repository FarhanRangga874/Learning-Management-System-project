<x-app-layout>
    ...
    <div class="pb-10 bg-slate-50 min-h-screen" x-data="{ accessType: 'open', certPolicy: 'manual' }">
        ...
        <form method="POST" action="{{ route('admin.courses.store') }}" enctype="multipart/form-data">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                ...
                <div class="mb-10 flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                    <div>
                        <h1 class="text-2xl font-bold text-slate-900">Buat Kursus Baru</h1>
                        <p class="text-slate-500 text-sm mt-1">Tambahkan materi pembelajaran ke dalam katalog.</p>
                    </div>
                </div>
                    ...
                    <div class="lg:col-span-2 space-y-8">
                            ...
                            <div class="space-y-5">
                                ...
                                <div class="prose max-w-none">
                                    ...
                                    <textarea name="description" id="description" rows="8" 
                                        class="block w-full px-4 py-3 text-slate-700 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 placeholder-slate-400 transition">{{ old('description') }}</textarea>
                        ...
                        <div class="bg-white border border-slate-200 rounded-xl shadow-sm p-6">
                            <div class="flex items-center justify-between mb-5 border-b border-slate-100 pb-3">
                                ...
                                {{-- TOMBOL TAMBAH BARIS (DENGAN BACKGROUND) --}}
                            ...
                            <div id="keypoints-container" class="space-y-3">
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-8 bg-slate-100 text-slate-500 rounded-lg flex items-center justify-center font-bold text-xs border border-slate-200">1</div>
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-white border border-slate-200 rounded-xl shadow-sm p-5">
                            ...
                            <div class="relative w-full h-44 rounded-lg border-2 border-dashed border-slate-300 bg-slate-50 hover:bg-indigo-50 hover:border-indigo-400 transition overflow-hidden group cursor-pointer" id="drop-area">
                                <input id="thumbnail" name="thumbnail" type="file" class="absolute inset-0 w-full h-full opacity-0 z-50 cursor-pointer" onchange="previewImage(event)" required>
                                
                                <div class="absolute inset-0 flex flex-col items-center justify-center text-center p-4" id="placeholder">
                                    ...
                                    <span class="text-xs font-medium text-slate-600">Klik untuk upload gambar</span>
                        ...
                        <div class="bg-white border border-slate-200 rounded-xl shadow-sm p-5 space-y-6">
                            ...
                            <div x-data="{
                                ...
                                selectedName: '{{ old('category_id') ? ($categories->find(old('category_id'))->name ?? 'Pilih Kategori') : 'Pilih Kategori' }}',
                                ...
                                {{-- LABEL + TOMBOL BUAT BARU (DENGAN BACKGROUND) --}}
                            ...
                            <div>
                                ...
                                <div x-show="accessType === 'code'" x-collapse class="mt-3">
                                    <input type="text" name="access_code" placeholder="Misal: KLS-VIP" 
                ...
                {{-- ==================== STATIC ACTION BAR (DI BAWAH FORM) ==================== --}}
