    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Mengedit bab pada kursus: <span class="font-bold text-indigo-600">{{ $course->title }}</span></p>
            </div>
        </div>
    </x-slot>
            ...
            <form method="POST" action="{{ route('admin.courses.chapters.update', [$course, $chapter]) }}">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
                    ...
                    <div class="mb-6 border-b border-gray-100 pb-4">
                        ...
                        <p class="text-sm text-gray-500">Sesuaikan nama bab jika diperlukan.</p>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-2">
                                Pastikan judul tetap relevan dengan isi materi di dalamnya.
                            </p>
                        </div>
