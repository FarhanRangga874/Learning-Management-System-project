            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div class="max-w-2xl">
                    ...
                    <p class="text-lg text-slate-600 leading-relaxed mb-8 pr-0 lg:pr-6">
                        Platform edukasi literasi digital terlengkap. Pelajari keamanan siber, etika internet, hingga keterampilan teknis untuk bersaing di era revolusi industri <span class=" text-blue-700">4.0</span>
                    </p>
    ...
    <div class="group relative flex flex-col bg-white rounded-[20px] overflow-hidden transition-all duration-500 hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)] border border-slate-100/60">
        ...
        <div class="px-5 py-5 flex flex-col flex-1">
            ...
            <div class="mb-2">
                ...
                @else
                    <span class="text-slate-500 bg-slate-100 text-[10px] font-bold px-2 py-0.5 rounded-md inline-flex items-center gap-1">
