<x-app-layout>
    ...
    {{-- Logic PHP: Ekstrak YouTube ID (DIBUNGKUS PENGECEKAN) --}}
    @php
        $youtubeId = '';
        // Perbaikan: Cek dulu apakah $currentLesson ada isinya
...
{{-- HEADER NAVIGATION (STICKY) --}}
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-12">
            ...
            {{-- 1. BREADCRUMBS (DITARUH PALING ATAS & DIBERI JARAK) --}}
            ...
            @if(!$currentLesson)
                <div class="flex flex-col items-center justify-center py-20 text-center bg-gray-50 rounded-3xl border-2 border-dashed border-gray-200">
                    ...
                    <p class="text-gray-500 mt-2 max-w-md">Instruktur belum mengunggah materi untuk kursus ini. Silakan kembali lagi nanti.</p>
                        ...
                        @else
                            ...
                            <div class="w-full bg-gradient-to-r from-indigo-50 via-white to-white rounded-2xl p-6 md:p-8 border border-indigo-100 mb-8 flex flex-col md:flex-row items-center gap-6 shadow-sm overflow-hidden relative">
                                ...
                                <div class="flex-shrink-0 relative z-10">
                                    <img src="https://illustrations.popsy.co/amber/woman-reading-tablet.svg" 
                                        alt="Woman Reading Tablet" 
                                        class="w-32 h-32 md:w-40 md:h-40 object-contain hover:scale-105 transition-transform duration-500">
                                </div>
                                <div class="text-center md:text-left flex-1 relative z-10">
                                    ...
                                    <p class="text-gray-500 text-sm leading-relaxed">
                                        Materi ini berbentuk bacaan teks komprehensif. Silakan gulir ke bawah untuk membaca materi lengkap dan memahami konsepnya.
                                    </p>
                                </div>
                            </div>
                        @endif
